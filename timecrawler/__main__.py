...
if __name__ == "__main__":
    ...
    parser.add_argument("--root_path", help="Root path for the directory structure.", default="data")
    parser.add_argument("--input_dir", help="Input directory to get_files from.")
